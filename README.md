...
|---|---|---|
| `client/src/assets/styles/_variables.scss` | Alle Design-Tokens: Farben, Fonts, Spacing, Shadows, Transitions als CSS Custom Properties; zusätzlich `--font-controls` als optionaler Control-Bar-Font-Slot (standardmäßig auf `--font-mono`) | ✅ Rewritten |
