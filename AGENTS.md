...
24. implement HLS/LL-HLS Phase 1: default-off configuration, authenticated bootstrap/playback-lease foundations, deterministic playlist/object models and golden fixtures without starting a packager or adding a client player — **NEXT**,
