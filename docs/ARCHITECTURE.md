...
- settings report the effective backend and override state. Healthy WebCodecs playback uses a compact status chip; negotiation, recovery and terminal failure retain the prominent receive-only/no-Picture-in-Picture explanation and explicit actions.
